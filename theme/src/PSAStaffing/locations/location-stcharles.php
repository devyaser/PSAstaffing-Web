...
<?php get_header(); ?>
    ...
    <div class="main_content">
        <section class="location_inner_banner pt-5">
            <div class="container">
                <a href="<?php echo get_home_url(); ?>/locations" class="custom_styled has_arrow before_arrow">Back to Locations</a>
                <h1 class="mt-4"><span style="color: var(--brand-blue-primary);">St. Charles </span>MO (STC)</h1>
            </div>
        </section>
        ...
        <section class="pt-5 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/STC.png" alt="St. Charles MO (STC)" width="100%">
                    </div>
                    <div class="col-md-7 stylingg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/Visit\ us.svg);">
                        <div>
                            ...
                            <p class="dark-primary">Address: <span class="dark-secondary">136 S Main StSt. Charles MO 63301</span></p>
                        </div>
