<?php /* Template Name: Cartersville */ ?>
    ...
    <div class="main_content">
        ...
        <section class="pt-5 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/CAR.png" alt="Cartersville" width="100%">
                    </div>
                    <div class="col-md-7 stylingg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/Visit\ us.svg);">
                        <div>
                            ...
                            <!-- <p class="dark-primary">Address: <span class="dark-secondary">11726 St. Charles Rock Road, Suite LBridgeton MO 63044</span></p> -->
                        </div>
