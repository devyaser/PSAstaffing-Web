    ...
    <div class="main_content">
        <section class="location_inner_banner pt-5">
            <div class="container">
                ...
                <h1 class="mt-4"><span style="color: var(--brand-blue-primary);">Tower Grove Ave </span>MO (TOG)</h1>
            </div>
        </section>
        ...
        <section class="pt-5 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/TOG.png" alt="Tower Grove Ave MO (TOG)" width="100%">
                    </div>
                    <div class="col-md-7 stylingg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/Visit\ us.svg);">
                        <div>
                            ...
                            <p class="dark-primary">Address: <span class="dark-secondary">1536 Tower Grove AveSt Louis MO 63110</span></p>
                        </div>
