    ...
    <div class="main_content">
        <section class="location_inner_banner pt-5">
            <div class="container">
                ...
                <h1 class="mt-4"><span style="color: var(--brand-blue-primary);">Doraville </span>GA (DOR)</h1>
            </div>
        </section>
        ...
        <section class="pt-5 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/DOR.png" alt="Doraville Park GA (DOR)" width="100%">
                    </div>
