    ...
    <div class="main_content">
        <section class="location_inner_banner pt-5">
            <div class="container">
                ...
                <h1 class="mt-4"><span style="color: var(--brand-blue-primary);">Gainesville </span>GA (GAI)</h1>
            </div>
        </section>
        ...
        <section class="pt-5 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/GAI.png" alt="Gainesville Park GA (GAI)" width="100%">
                    </div>
                    <div class="col-md-7 stylingg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/Visit\ us.svg);">
                        <div>
                            <h2>Visit us</h2>
                            <p class="dark-primary">Open: <span class="dark-secondary">2024</span></p>
