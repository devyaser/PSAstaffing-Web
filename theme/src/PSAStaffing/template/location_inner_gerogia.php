<?php /* Template Name: Location Inner Georgia */ ?>
...
<?php get_header(); ?>
    ...
    <div class="main_content">
        <section class="location_inner_banner pt-5">
            <div class="container">
                <a href="<?php echo get_home_url();?>/location" class="custom_styled has_arrow before_arrow">Back to Locations</a>
                <h1 class="mt-4"><span style="color: var(--brand-blue-primary);">Cartersville</span> GA (CAR)</h1>
            </div>
        </section>
        ...
        <section class="pt-5 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <img class="inner-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/CAR.png" alt="Nashville IL (NAS)" width="100%">
                    </div>
                    <div class="col-md-7 stylingg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/visit-us-georgia.svg);">
                        <div>
                            <h2>Visit us</h2>
                            <p class="dark-primary">Open: <span class="dark-secondary">M-F 8:30 AM – 5:00 PM</span></p>
                            <p class="dark-primary">Address: <span class="dark-secondary">12578 State Rt. 127, P.O. Box 128Nashville IL 62263</span></p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 pt-4">
                        <div class="location-inner-map" id="mapSec">
                            <img width="100%" src="<?php echo get_template_directory_uri(); ?>/assets/images/inner_map_georgia.png" alt="inner map">
                        </div>
                        ...
                        <div class="form-conatiner">
                            ...
                            <form id="inenrform" class="pt-4">
                                ...
                                <div class="mb-3">
                                 ...
                                 <a class="blue text-decoration-none" href="<?php echo get_home_url();?>/about" target="_blank"> Learn more about our hiring programs</a>
                                </div>
                                <div class="mb-3">
